use nft_mint_bot::config::{
    ABSTRACT_DEFAULT_MAX_GAS_COST_NATIVE, ABSTRACT_MAINNET_CHAIN_ID, HYPEREVM_DEFAULT_GAS_LIMIT,
    HYPEREVM_MAINNET_CHAIN_ID, INK_DEFAULT_GAS_LIMIT, INK_MAINNET_CHAIN_ID,
...
#[test]
fn interactive_mint_supports_abstract_mainnet() {
    assert_eq!(ABSTRACT_MAINNET_CHAIN_ID, 2741);
    assert_eq!(ABSTRACT_DEFAULT_MAX_GAS_COST_NATIVE, "0.001");
}
